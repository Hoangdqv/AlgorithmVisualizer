...
const EditorComponent = ({toggleSidebar, showSidebar, toggleDropdown, isOpen, loading, selectedLanguage, languages, handleLanguageSelect, runCode, isRunning, handleFileSelect, samplesCache, code, handleEditorChange, output, sidebarLanguageKey, tracerData, onBack}) => {
  return (
